            ...
            <div className="glass-panel p-8 rounded-2xl border border-white/10 relative about-card">
              ...
              <div className="space-y-8 relative">
                ...
                <div className="relative pl-10">
                  <div className="absolute left-3 top-1 w-6 h-6 rounded-full bg-neutral-900 border border-white/20 flex items-center justify-center z-10 -translate-x-1/2">
                ...
                <div className="relative pl-10">
                  <div className="timeline-dot absolute left-3 top-1 w-6 h-6 rounded-full bg-neutral-900 border border-white/20 flex items-center justify-center z-10 -translate-x-1/2">
                ...
                <div className="relative pl-10">
                  <div className="timeline-dot timeline-dot-active absolute left-3 top-1 w-6 h-6 rounded-full bg-neutral-900 border border-red-500/50 flex items-center justify-center z-10 -translate-x-1/2">
