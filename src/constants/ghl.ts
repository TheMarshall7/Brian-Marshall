 ...
 * Override with VITE_GHL_PRECALL_WEBHOOK_URL.
 */
export const DEFAULT_GHL_PRECALL_WEBHOOK_URL = `${GHL_HOOKS_BASE}/CDwE3CsYmPCqkb3M23Rn`

/**
 * AOF Self-Audit quiz on /aof.
 * Override with VITE_GHL_SELF_AUDIT_WEBHOOK_URL.
 * Email should use meta: score, band, gaps, priorityFixes, whereToStart, pdfUrl, resultsSummary.
 */
export const DEFAULT_GHL_SELF_AUDIT_WEBHOOK_URL = `${GHL_HOOKS_BASE}/Oj7se5RdETlifCUQHZZ1`

/** Paid AOF Master Audit booking ($1,497) — not the free 15-min qualifying call on /calendar. */
...
/** GHL booking widget for AOF Master Audit purchase ($1,497). Override with VITE_AOF_PURCHASE_WIDGET_SRC. */
